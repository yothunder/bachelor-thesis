...
timelag = '1 21'
timelaglab = '-10 10'
ptextmarksize = '-t E P -m 3 3 -z 0.05 0.05'
prange = '-r -3 3'
xlint = '4'; ylint = '1'
xycfg = '1 3 0.15'
...
var.1.1 = '-v ecsmeanra*4*1000 tpcsmeanra*4*1000'; 
var.2.1 = '-v ecsmeanrb*4*1000 tpcsmeanrb*4*1000'
var.3.1 = '-v ecsmeanrc*4*1000 tpcsmeanrc*4*1000'; 
var.4.1 = '-v ecsmeanrd*4*1000 tpcsmeanrd*4*1000'
var.1.2 = '-v ecensmeanra*4*1000 tpcensmeanra*4*1000'; 
var.2.2 = '-v ecensmeanrb*4*1000 tpcensmeanrb*4*1000'
var.3.2 = '-v ecensmeanrc*4*1000 tpcensmeanrc*4*1000'; 
var.4.2 = '-v ecensmeanrd*4*1000 tpcensmeanrd*4*1000'
...
'legend -orient h -xo -4 -yo -3 -scale 5'

'printim D:\Sem8\Skripsi\#1_OLAH\vis\3_1_mb.pdf white'
'printim D:\Sem8\Skripsi\#1_OLAH\vis\3_1_mb.png white'
