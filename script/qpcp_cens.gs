...
var.1.1 = 'q1pcpcensmeanra'; var.1.2 = 'q1pcpcensmeanrb'
var.1.3 = 'q1pcpcensmeanrc'; var.1.4 = 'q1pcpcensmeanrd'
var.2.1 = 'q2pcpcensmeanra'; var.2.2 = 'q2pcpcensmeanrb'
var.2.3 = 'q2pcpcensmeanrc'; var.2.4 = 'q2pcpcensmeanrd'

pvar.1.1 = 'q1pcpcenspvalra'; pvar.1.2 = 'q1pcpcenspvalrb'
pvar.1.3 = 'q1pcpcenspvalrc'; pvar.1.4 = 'q1pcpcenspvalrd'
pvar.2.1 = 'q2pcpcenspvalra'; pvar.2.2 = 'q2pcpcenspvalrb'
pvar.2.3 = 'q2pcpcenspvalrc'; pvar.2.4 = 'q2pcpcenspvalrd'

tileopt = '0 0.05 -type 2 -int 5 -color 0'
xcbaropt = '1 9 1 1.2 -fw 0.15 -fh 0.18 -fskip 2 -edge triangle -line on'
...
while (ic<=4)
  ...
  while (ir<=2)
    ...
    if ic = 1
      'set ylint '100
      'color -8 8 1 -kind deepskyblue->skyblue->cyan->white->gold->red->maroon'
      'd 'var.ir.ic
      'set gxout contour'
      'set ccolor 1'
      'set clopts 1 -1 0.07'
      ...
      if ir=2
        if ic=4
          ...
          'xcbar 'xcbaropt
          'set strsiz 0.18 0.2'
          'draw string 9.7 1 (K/day)'
          'set gxout shaded'
          'tile 'pvar.ir.ic' 'tileopt
          'draw xlab jeda waktu'
        endif
      endif
      ;*'color -8 8 1 -kind purple->blue->skyblue->white->gold->red->maroon'
      'color -8 8 1 -kind deepskyblue->skyblue->cyan->white->gold->red->maroon'
      'd 'var.ir.ic
      'set gxout contour'
      'set ccolor 1'
...
'printim D:\Sem8\Skripsi\#1_OLAH\vis\rev\2_2_2_qpcp_cens_90.pdf white'
*'printim D:\Sem8\Skripsi\#1_OLAH\vis\2_2_2_qpcp_cens.svg white'
'reinit'
...
while (ic<=4)
  ...
  while (ir<=2)
    ...
    if ic = 1
      'set ylint '100
      'color -8 8 1 -kind royalblue->deepskyblue->powderblue->white->gold->red->maroon'
      'd 'var.ir.ic
      'set gxout contour'
      'set ccolor 1'
      'set clopts 1 -1 0.07'
...
'printim D:\Sem8\Skripsi\#1_OLAH\vis\rev\2_2_2_qpcp_cens_95.pdf white'
'printim D:\Sem8\Skripsi\#1_OLAH\vis\rev\2_2_2_qpcp_cens_95.svg white'
