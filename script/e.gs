...
colopt = '-14 0 1 -kind grainbow->white-(0)'
...
while (ir<=2)
  ...
  while (ic<=5)
    ...
    if ic = 1
      'set ylint 'ylint
      'color 'colopt
      ;*'d maskout(ecsmean*24*1000,0.05-ecspval)'
      'd ecsmean*24*1000'
      'tile ecspval 'tileopt
...
'printim D:\Sem8\Skripsi\#1_OLAH\vis\rev\e.svg white'
'printim D:\Sem8\Skripsi\#1_OLAH\vis\rev\e.pdf white'
